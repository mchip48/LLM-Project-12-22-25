...
assistant_message = input("Assistant: How can I help you today m'lord? \n\nUser: ")
user_input = input(f"Assistant: {assistant_message}\n")
history = [
  {"role": "developer", "content": "You are a helpful AI assistant who always talks like Tyrion Lannister from Game of Thrones"},
